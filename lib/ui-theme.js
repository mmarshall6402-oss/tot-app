...
export const S = {
  ...
  dateScroll: { display: "flex", gap: 6, padding: "10px 20px", overflowX: "auto" },
  dateBtn: { flexShrink: 0, padding: "7px 14px", borderRadius: 999, fontSize: 12, fontWeight: 600, border: "1px solid", letterSpacing: 0.2, whiteSpace: "nowrap", transition: t.transition },
  subNav: { display: "flex", alignItems: "center", justifyContent: "space-between", gap: 8, padding: "10px 20px" },
  ...
  content: { flex: 1, padding: "12px 20px 84px", display: "flex", flexDirection: "column", gap: 12, overflowY: "auto" },
  ...
  card: { background: t.color.surface, border: "1px solid", borderRadius: t.radius.md, padding: "14px 16px", transition: "border-color 0.2s", animation: "fadeUp 0.3s ease" },
