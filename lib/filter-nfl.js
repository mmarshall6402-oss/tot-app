...
// marketType: "moneyline" | "spread". For "spread", modelProb must be the spread-cover
// probability (getNFLSpreadCoverProbability), not the moneyline win probability — the
// caller chooses which model output to pass in.
