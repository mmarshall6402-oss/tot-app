...
function _applyFilterLayer(pick, game, mlb, modelProb) {
  ...
  const blend         = (variance === "HIGH" ? 0.06 : variance === "MED" ? 0.12 : 0.20)
  ...
  const trueWinProb    = Math.min(sharpImpliedP + 0.06, rawBlend);
  ...
  const dynamicMinEdge = sharpImpliedP != null && sharpImpliedP >= 0.62 ? 0.8
                       : sharpImpliedP != null && sharpImpliedP >= 0.57 ? 1.0
                       : MIN_TRUE_EDGE * 100;
