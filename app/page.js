    ...
    <div style={S.app}>
                    ...
                    {ls?.status === "Final" && (
                      <div style={{ marginTop: 8 }}>
                        ...
                        {(() => {
                          ...
                          if (!recap || recap === "loading") return <div style={{ fontSize: 11, color: "#3d424f", marginTop: 6 }}>Generating recap...</div>;
          ...
          <div style={{ background: "#15171d", border: "1px solid #242832", borderRadius: 14, padding: "16px 18px", display: "flex", flexDirection: "column", gap: 10 }}>
            ...
            {isPro ? (
              <>
                ...
                <button style={{ ...S.saveBtn, textAlign: "left", padding: "10px 12px", color: "#D9645C", borderColor: "rgba(217,100,92,0.3)" }} onClick={cancelSubscription}>Cancel Subscription</button>
              </>
            ) : (
      ...
      {showDeleteModal && (
        <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: "rgba(0,0,0,0.82)", display: "flex", alignItems: "flex-end", justifyContent: "center" }}
          ...
          <div style={{ width: "100%", maxWidth: 500, background: "#12141a", borderRadius: "24px 24px 0 0", border: "1px solid rgba(217,100,92,0.25)", borderBottom: "none", padding: "0 0 max(28px, env(safe-area-inset-bottom)) 0" }}
      ...
      <div onClick={e => e.stopPropagation()} style={{ width: "100%", maxWidth: 480, background: "#12141a", border: "1px solid #1e1e1e", borderRadius: 16, overflow: "hidden", maxHeight: "76vh", display: "flex", flexDirection: "column", animation: "fadeUp 0.15s ease" }}
        ...
        <div style={{ overflowY: "auto", padding: q ? "6px 0" : "0" }}>
          ...
          {gameResults.length > 0 && (
            <div>
              <div style={{ padding: "8px 16px 4px", fontSize: 10, fontWeight: 700, color: "#555", letterSpacing: 1.5 }}>GAMES</div>
              {gameResults.map(p => {
                const isOpen = activeId === `g-${p.id}`;
                return (
                  <div key={p.id}>
                    <div
