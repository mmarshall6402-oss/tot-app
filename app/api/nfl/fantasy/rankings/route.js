...
export async function GET(request) {
  ...
  let query = supabase
    ...
    .select("player_id, name, position, team, projected_points, ceiling_points, floor_points, vorp, ceiling_vorp, rank_overall, rank_position, tier, injury_status, injury_risk, trending_add_count, season, updated_at")
